...
This config extends `@commitlint/config-conventional`. The full effective rule set is listed below; rows where the project value differs from the upstream default are this package's overrides.
