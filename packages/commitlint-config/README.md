...
This config extends `@commitlint/config-conventional` and overrides only the rules below. Every other rule uses the `@commitlint/config-conventional` default.
